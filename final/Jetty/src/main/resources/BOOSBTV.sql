...
CREATE TABLE IF NOT EXISTS MOVIE (
    ...
    pathHigh VARCHAR (225) NOT NULL,
    pathLow VARCHAR (225) NOT NULL,
    Descricao VARCHAR(1000) DEFAULT 'No description',
    duration time DEFAULT '00:00:00',
    year INT DEFAULT 0,
    genre VARCHAR(50) DEFAULT 'No genre',
    Thumbnail VARCHAR(250) DEFAULT 'https://prescotthobbies.com/wp-content/uploads/2019/12/image-not-available-684f2d57b8fb401a6846574ad4d7173be03aab64aac30c989eba8688ad9bfa05.png',
    uploadedBy  VARCHAR(80) DEFAULT 'Anonymous'
);
...
insert into USER (username, password, fullname, isCreator) values ('corvo', 'corvo', 'Francisco', false);
